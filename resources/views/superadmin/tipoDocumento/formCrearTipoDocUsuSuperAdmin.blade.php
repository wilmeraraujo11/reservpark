...
<div class="modal modal-default fade" id="modal-default">
  <div class="modal-dialog">
      <div class="modal-content" style="background-color: #dfdfdf;">
        <form method="POST" action="{{ route('registroTdocUsuarios.store') }}" enctype="multipart/form-data">
          @csrf
            ...
            <div class="modal-body">
              <div class="form-group">
                <input id="cc" type="text" name="cc" class="form-control" required autofocus placeholder="Nombre">
              </div>  
