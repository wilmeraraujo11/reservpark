  ...
  <div class="col-lg-4">
    <form method="POST" action="/admin" enctype="multipart/form-data">
                              ...
                              <select  name="tdoc" class="form-control">
                                <option value="">{{ $users->tdoc }}</option>
                              ...
                              <select  name="desc_tipo" class="form-control">
                                <option value="">{{ $users->desc_tipo }}</option>
                              ...
                              <!--numero de documento-->
                              <div class="form-group">
                                <input id="no_documento" type="text" name="no_documento" class="form-control{{ $errors->has('no_documento') ? ' is-invalid' : '' }}" value="{{ $users->no_documento }}" required autofocus placeholder="Número de documento">
                              ...
                              <!--Nombres-->
                              <div class="form-group">
                                <input id="name" type="text" name="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ $users->name }}" required>
                                @if ($errors->has('name'))
                                    <span class="invalid-feedback" role="alert">
